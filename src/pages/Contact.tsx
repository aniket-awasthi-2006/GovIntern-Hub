...
const Contact = () => {
  ...
  return (
    <div className="space-y-16">
      {/* Header */}
      <section className="bg-gradient-to-br from-primary to-primary-hover text-primary-foreground animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="text-center hover-lift animate-stagger-1">
            <CardContent className="pt-6 space-y-3">
              <Mail className="h-12 w-12 text-primary mx-auto animate-float hover-icon-bounce" />
              <h3 className="font-semibold">Email Support</h3>
              <p className="text-sm text-muted-foreground">
                support@govinternhub.gov.in
              </p>
              <Badge variant="secondary" className="animate-scale-in">24/7 Available</Badge>
            </CardContent>
          </Card>

          <Card className="text-center hover-lift animate-stagger-2">
            <CardContent className="pt-6 space-y-3">
              <Phone className="h-12 w-12 text-primary mx-auto animate-float hover-icon-bounce" />
              <h3 className="font-semibold">WhatsApp Support</h3>
              <p className="text-sm text-muted-foreground">
                +91 98765 43210
              </p>
              <Badge variant="secondary" className="animate-scale-in">Mon-Fri 9AM-6PM</Badge>
            </CardContent>
          </Card>

          <Card className="text-center hover-lift animate-stagger-3">
            <CardContent className="pt-6 space-y-3">
              <MapPin className="h-12 w-12 text-primary mx-auto animate-float hover-icon-bounce" />
              <h3 className="font-semibold">Office Address</h3>
              <p className="text-sm text-muted-foreground">
                Digital India Building<br />
                New Delhi - 110001
              </p>
              <Badge variant="secondary" className="animate-scale-in">Visit by Appointment</Badge>
            </CardContent>
          </Card>

          <Card className="text-center hover-lift animate-stagger-4">
            <CardContent className="pt-6 space-y-3">
              <Clock className="h-12 w-12 text-primary mx-auto animate-float hover-icon-bounce" />
              <h3 className="font-semibold">Response Time</h3>
              <p className="text-sm text-muted-foreground">
                Within 24 hours
              </p>
              <Badge variant="secondary" className="animate-scale-in">Fast Support</Badge>
            </CardContent>
          </Card>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <Card className="animate-stagger-6">
                <CardHeader>
      ...
      {/* Support Hours */}
      <section className="bg-accent animate-fade-in">
          ...
          <div className="text-center space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              ...
              <div className="animate-stagger-2">
                ...
                <p className="text-xs text-muted-foreground">9:00 AM - 5:00 PM IST</p>
              </div>
